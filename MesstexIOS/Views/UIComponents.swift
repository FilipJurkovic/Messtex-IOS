...
struct TextEditingField: View {

<<<<<<< Updated upstream:MesstexIOS/Views/UIComponents.swift
    var fieldTitle: String
    @State var fieldValue: String
    var body: some View {
        TextField(fieldTitle, text: $fieldValue)
            .padding()
            .background(Color(red: 239.0 / 255.0, green: 243.0 / 255.0, blue: 243.0 / 255.0, opacity: 1.0))
            .cornerRadius(30.0)
...
struct StepIndicator: View {
    var stepIndex: Int
>>>>>>> Stashed changes:MesstexIOS/Utility/UIComponents.swift
    var body: some View {
...
<<<<<<< Updated upstream:MesstexIOS/Views/UIComponents.swift
        Button(action: { withAnimation { viewModel.setPage(page: pageEnum) } }) {
            Text(buttonTitle)
                .font(.headline)
    ...
    var body: some View{
        VStack{
                ...
                HStack{
                    ...
                    VStack(alignment:.leading){
                        Text("Thank you,\neverything is done!")
                            ...
                            .foregroundColor(.light)
                            .padding(.bottom, 5)
                        Text("Check out our tips and\ntricks discover more from\nthe Messtex world")
                            .paragraph()
                            .foregroundColor(.light)
                    }
                }
            ...
            NavigationLink(
                        ...
                        label : {
                            OutlinedButtonStyle(buttonLabel: "Learn more about us")
                        })
        }
    }
}
            ...
            ZStack(alignment: .bottom){
                ...
                VStack{
                 ...
                 Text(String(co2Level))
                    ...
                    Text("kilograms of CO₂\nwe have already saved together!")
                      .paragraph()
                      .foregroundColor(.light)
                      .padding(.bottom, 34)
        ...
        ZStack{
            ...
            HStack{
                ...
                VStack(alignment:.leading){
                    ...
                    Text("We want to digitize every\nmanual reading in\nGermany!")
                        .paragraph()
                        .alignmentGuide(.top, computeValue: { dimension in
                            dimension[.top]
